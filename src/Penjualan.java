...
public class Penjualan extends javax.swing.JPanel {
    ...
    public class TransaksiJual {
        ...
        public void hitungTotal() {
            try {
                ...
                namaKasir = text_kasir.getSelectedItem().toString();
        ...
        public void refresComboKasir() {
            try {
                ...
                text_kasir.removeAllItems(); // Hapus data sebelumnya dari combo box
                while (rs.next()) {
                    String username = rs.getString("username");
                    text_kasir.addItem(username);
    ...
    private void initComponents() {
        ...
        text_kasir = new javax.swing.JComboBox<>();
        ...
        text_kasir.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        panel_utama.add(text_kasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 130, 218, 40));
    ...
    private javax.swing.JComboBox<String> text_kasir;
