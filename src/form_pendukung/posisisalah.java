 ...
 * @author acer
 */
public class posisisalah extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Harap pilih posisi anda dengan benar!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(posisisalah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new posisisalah().setVisible(true);
            }
        });
    }
